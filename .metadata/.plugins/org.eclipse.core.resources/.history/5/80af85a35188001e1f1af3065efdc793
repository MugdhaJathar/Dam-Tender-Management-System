              ...
              <!-- Developer 1 Mr. Shashi Raj-->
                <div class="col-md-3 col-xs-12 col-sm-3" >
                  ...
                  <div class="col-md-7 col-xs-7 col-sm-7">
                    ...
                    <br/>
                    <span style="font-size: 1.7em; color:red">Mr. Jalinder Gandal</span>
              ...
              <!-- Developer 2 Ms. Ahana Guchait -->
                <div class="col-md-2 col-xs-12 col-sm-2">
                  ...
                  <div class="col-md-7 col-xs-7 col-sm-7">
                    <div class="developers pull-left" style="font-weight: bold; color:white;text-align: center;">
                    <br/>
                    <span style="font-size: 1.7em; color:red">Ms. Siddhi Chavan</span>
 ...
 -->                    
              ...
              <div class="col-md-2 col-xs-12 col-sm-2">
                ...
                <div class="col-md-7 col-xs-7 col-sm-7">
                  <div class="developers pull-left" style="font-weight: bold; color:white;text-align: center;">
                  <br/>
                  <span style="font-size: 1.7em; color:red">Ms. Mugdha Jathar</span>
<!--                   <p><span>Web Designer</span></p>
 -->                  
                  </div>
                </div>
  ...
  <div class="navbar-inverse" style="color:white;padding:05px;margin-bottom:-17px;text-align: center;background-color:green; border-radius: 0px">
                      <span style="float:left;padding-left: 6.5%"> </span><span style="padding-left:5%;">&nbsp; Dam Tender Management Portal</span><span style="float:right;padding-right: 6%" class="hidden-xs">&nbsp;...THANKS FOR VISITING...</span>
</div><br/>
